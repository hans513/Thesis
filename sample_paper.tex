...
% DATA SET
Each data set consists of 10 configurations in 10 environments, corresponding to 100 instances. Ethane has eight nuclei which, along with kinetic energy and two-electron energy, leads to 1000 data points. 
